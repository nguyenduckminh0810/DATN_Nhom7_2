...
public class ThongKeController {
    ...
    public ResponseEntity<List<Map<String, Object>>> categoryPerformance(
            @RequestParam(name = "limit", required = false) Integer limit,
            @RequestParam(name = "rangeDays", required = false) Integer rangeDays) {
        return ResponseEntity.ok(thongKeService.getCategoryPerformance(limit, rangeDays));
    }
    ...
    public ResponseEntity<Map<String, Object>> analyticsKpis(
        ...
        return ResponseEntity.ok(thongKeService.getAnalyticsKpis(startDate, endDate));
    }
    ...
    public ResponseEntity<Map<String, Object>> businessInsights(
            @RequestParam(name = "startDate", required = false) String startDate,
            @RequestParam(name = "endDate", required = false) String endDate) {
        return ResponseEntity.ok(thongKeService.getBusinessInsights(startDate, endDate));
    }
    ...
    public ResponseEntity<Map<String, Object>> performanceMetrics(
            @RequestParam(name = "startDate", required = false) String startDate,
            @RequestParam(name = "endDate", required = false) String endDate) {
        return ResponseEntity.ok(thongKeService.getPerformanceMetrics(startDate, endDate));
    }
    ...
    public ResponseEntity<Map<String, Object>> orderDistribution(
            ...
            @RequestParam(name = "startDate", required = false) String startDate,
            @RequestParam(name = "endDate", required = false) String endDate) {
        return ResponseEntity.ok(thongKeService.getOrderDistribution(type, startDate, endDate));
    }
    ...
    public ResponseEntity<Map<String, Object>> customerAnalytics(
            ...
            @RequestParam(name = "startDate", required = false) String startDate,
            @RequestParam(name = "endDate", required = false) String endDate) {
        return ResponseEntity.ok(thongKeService.getCustomerAnalytics(type, startDate, endDate));
    }
}
